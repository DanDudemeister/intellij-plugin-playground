...
public class ComparingReferencesInspection extends BaseJavaLocalInspectionTool {
    private static final Logger LOG = Logger.getInstance("#ComparingReferencesInspection");
    ...
    private static class MyQuickFix implements LocalQuickFix {
        ...
        // Für später: Code, um neue Klasse anzulegen
//        @Override
//        public void applyFix(@NotNull Project project, @NotNull ProblemDescriptor problemDescriptor) {
//            PsiFile containingFile = returnStatement.getParent().getParent().getParent().getContainingFile();
//            PsiJavaFile javaFile = (PsiJavaFile) containingFile;
//            PsiPackage pkg = JavaPsiFacade.getInstance(project).findPackage(javaFile.getPackageName());
//
//            PsiDirectory parent = (PsiDirectory) returnStatement.getParent().getParent().getParent().getParent().getParent();
//
//            JavaDirectoryService javaDirectoryService = JavaDirectoryService.getInstance();
//            javaDirectoryService.createClass(parent, "TestClass");
//        }
